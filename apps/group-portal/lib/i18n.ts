...
const pl: Record<string, string> = {
  ...
  "rsvp.alreadyRespondedInfo": "Juz udzielono odpowiedzi. Mozesz ja zmienic ponizej.",
  "rsvp.submitConfirm": "Wyslij potwierdzenie",
  "rsvp.submitDecline": "Wyslij odmowe",
  "rsvp.changeGuest": "Zmien",
  "rsvp.step.identity": "1. Kim jestes?",
  "rsvp.step.attendance": "2. Czy przyjedziesz?",
  "rsvp.step.details": "3. Dodatkowe informacje",
  "rsvp.notOnList": "Nie znaleziono Ciebie na liscie gosci",
  "rsvp.notOnListDesc": "Przejdz do zakladki 'Dolacz do wydarzenia' aby sie zarejestrowac.",
  "rsvp.popup.title": "Potwierdzasz uczestnictwo?",
  "rsvp.popup.subtitle": "Daj znac organizatorowi czy bedziesz na wydarzeniu.",
  "rsvp.status.confirmed": "Uczestnictwo potwierdzone",
  "rsvp.status.declined": "Uczestnictwo odrzucone",
  "rsvp.status.pending": "Oczekuje na odpowiedz",
  "rsvp.changeAnswer": "Zmien odpowiedz",
  "rsvp.yourStatus": "Twoj status",
